...
export function authLoginPost(http: HttpClient, rootUrl: string, params: AuthLoginPost$Params, context?: HttpContext): Observable<StrictHttpResponse<TokenResponse>> {
